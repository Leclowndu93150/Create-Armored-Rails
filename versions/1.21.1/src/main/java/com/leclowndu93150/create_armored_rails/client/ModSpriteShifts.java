...
public class ModSpriteShifts {
    ...
    private static CTSpriteShiftEntry omni(String name) {
        return CTSpriteShifter.getCT(AllCTTypes.OMNIDIRECTIONAL,
                ResourceLocation.fromNamespaceAndPath(CreateArmoredRails.MODID, "block/" + name),
                ResourceLocation.fromNamespaceAndPath(CreateArmoredRails.MODID, "block/" + name + "_connected"));
    }
}
