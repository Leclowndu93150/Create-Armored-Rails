...
public class Config {
    public static final ConfigClassHandler<ConfigData> HANDLER = ConfigClassHandler.createBuilder(ConfigData.class)
            .id(new ResourceLocation(CreateArmoredRails.MODID, "config"))
